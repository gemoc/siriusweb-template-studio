...
TODO fix the command to run the application, and update the instructions.
[source, bash]
----
mvn clean package
java -jar backend/template-studio-backend/target/*.jar
----
and then open your browser and navigate to: http://localhost:8080
